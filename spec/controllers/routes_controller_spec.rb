  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved route as @route" do
        ...
        post :create, {:route => { "user_id" => "invalid value" }}, valid_session
        assigns(:route).should be_a_new(Route)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested route" do
        ...
        Route.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => route.to_param, :route => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the route as @route" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Route.any_instance.stub(:save).and_return(false)
        put :update, {:id => route.to_param, :route => { "user_id" => "invalid value" }}, valid_session
        assigns(:route).should eq(route)
      end
